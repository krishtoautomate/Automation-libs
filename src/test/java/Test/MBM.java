...
//		TestDataManager TestDataManager = new com.DataManager.TestDataManager(filePath, className, platformName);
		...
		desiredCapabilities.setCapability(MobileCapabilityType.UDID, "0B271FDD4003AS");// device id //adb devices //
																						// commnad
...
//		desiredCapabilities.setCapability("avdReadyTimeout", 5);
		...
		desiredCapabilities.setCapability("appPackage", "ca.bell.selfserve.mybellmobile.dev.projectD");
		desiredCapabilities.setCapability("appActivity",
				"ca.bell.selfserve.mybellmobile.ui.splash.view.SplashActivity");
