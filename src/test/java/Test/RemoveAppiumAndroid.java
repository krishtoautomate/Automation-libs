...
public class RemoveAppiumAndroid {
	...
	public static void main(String[] args) {
		...
		runCommandThruProcess("/usr/local/share/android-sdk/platform-tools/adb -s "+udid+" uninstall io.appium.uiautomator2.server");
		runCommandThruProcess("/usr/local/share/android-sdk/platform-tools/adb -s "+udid+" uninstall io.appium.uiautomator2.server.test");
		runCommandThruProcess("/usr/local/share/android-sdk/platform-tools/adb -s "+udid+" uninstall io.appium.settings");
