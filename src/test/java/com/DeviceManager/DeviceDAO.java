...
public class DeviceDAO implements ITestBase {
	...
	public synchronized String getBrand() {
		if (this.getOs().equalsIgnoreCase("iPhone OS"))
			...
			this.brand = runCommandThruProcess(Constants.ADB + " -s " + this.udid + " shell getprop ro.product.brand")
					.replaceAll("\n", "");
		return brand;
	}
	...
	public synchronized String getDeviceModel() {
		if (this.getOs().equalsIgnoreCase("iPhone OS"))
			this.deviceModel = runCommandThruProcess(Constants.IDEVICEINFO + " -u" + this.udid + " -k ProductType");
		else
	...
	public synchronized String getosVersion() {
		if (this.getOs().equalsIgnoreCase("iPhone OS"))
			this.osVersion = runCommandThruProcess(Constants.IDEVICEINFO + " -u" + this.udid + " -k ProductVersion");
