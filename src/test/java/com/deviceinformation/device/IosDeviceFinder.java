...
public class IosDeviceFinder implements DeviceFinder<Ios> {
  ...
  public DeviceInfoModel<Ios> findDevices(String localPath) throws IOException {
    DeviceInfoModel<Ios> deviceInfoModel = JsonHelper.convertJsonToDeviceInfo(
  ...
  public Map<String, Object> readDeviceInfo(String localPath) throws IOException {
    ...
    Process deviceListProcess = ProcessHelper
        .runTimeExec(String.format("%s%s", localPath, LIB_MOBILE_DEVICE_LIST_SHELL_COMMAND));
    ...
    while ((line = reader.readLine()) != null) {
      ...
      Process deviceDetailInfoProcess = ProcessHelper
          .runTimeExec(String.format("%s%s", localPath, LIB_MOBILE_DEVICE_UDID_PUT_SHELL_COMMAND)
