...
public class Constants {
  ...
  public static final String REPORT_DIR = OUTPUT_DIRECTORY + "extent-report/";
  ...
  public static final String EXTENT_JSON_REPORT = REPORT_DIR + SET_BUILD_NUMBER+"/AUTOMATION_REPORT" + ".json";
