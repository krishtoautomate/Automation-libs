...
public class BaseObjs<T> {
	...
	*/
    public void AssertContains(String Actual, String Expected) {
		...
		if(StringUtils.containsIgnoreCase(actual, expected) |
				StringUtils.containsIgnoreCase(expected, actual) &&
				!actual.isEmpty()) {
	...
	*/
	 ...
	 */                                                                               
	By remindMeLater_btn = By.xpath("//android.widget.Button[contains(@resource-id, 'remindMeLatterButton') or @text='REMIND ME LATER' or @text='Remind me later']");
