...
public class AttributeImp extends TestUI implements testUI.elements.Attribute {
  ...
  protected AttributeImp(By AppiumElement, By SelenideElement, By iOSElement, int index,
      boolean collection, String accesibilityId, String accesibilityIdiOS, String Attribute,
      int time, boolean is) {
  ...
  public UIElement equalTo(String value) {
    ...
    if (collection) {
      waitUntilHasAttribute(getAppiumElement(iOSElement, AppiumElement),
          getAccesibilityId(accesibilityIdiOS, accesibilityId), index, time, Attribute, value, is);
    } else {
      waitUntilHasAttribute(getAppiumElement(iOSElement, AppiumElement),
          getAccesibilityId(accesibilityIdiOS, accesibilityId), time, Attribute, value, is);
    }
    // } else {
    // selenideAssert(
